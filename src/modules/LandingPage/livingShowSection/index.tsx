        ...
        <li className=" col-span-6">
          <div className="grid grid-cols-6 gap-y-116 gap-x-24">
            ...
            <div className="col-span-6 px-27 relative flex flex-col items-center">
              ...
              <Link href="/liveStream" className=" text-primary-red bg-white py-16 px-24 flex rounded-[20px] items-center gap-16 border border-dashed border-primary-red hover:outline hover:outline-8 hover:outline-primary-yellow group">
