...
const IntroductSection = () => {
  return (
    <section className=" bg-detailBG pt-100 bg-repeat-x bg-lightWhite">
      <ul className="container pb-60">
        <li className="mb-26">
          ...
          <div className="grid grid-cols-12 gap-24">
            ...
            />
            <div className="col-start-5 col-end-12 -ml-[70px]">
