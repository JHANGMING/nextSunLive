...
import { globalIconSet, grassMotionSet } from "@/constants/globaIIcon";
  ...
  return (
    <footer className="pt-41">
      <ul className="flex gap-154 items-end">
        <li>
          <Image {...grassMotionSet.grassMotionLeft} width={489} height={136} className=" self-end" />
        </li>
        <li className="text-primary-green flex flex-col items-center mb-40">
          <Image {...globalIconSet.logoImage} width={32} height={32} className="mb-8" />
          <h3>搶鮮購</h3>
        ...
        <li>
          <Image {...grassMotionSet.grassMotionRight} width={489} height={136} />
        </li>
      </ul>
